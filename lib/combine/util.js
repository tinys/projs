...
(function(module) {
  ...
  function getSourceByCompress(codeStr,Opts){
    ...
    commentText = formatCommentText(Opts.commentText);
    ...
    if(fileType == 'js'){
      ...
      codeStr = '@charset "'+(Opts.config.origin.css_charset || 'utf-8')+'"\;'+codeStr;
  ...
  function getFileCodeStr(filePath, Opts) {
    ...
    if (path.existsSync(filePath)) {
      ...
      console.error(codeStr = "found out abort file: " + filePath + '\n');
    }
