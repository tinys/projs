...
(function(module){
   ...
   */
  function combine(fileMap,Opts,callback){
    ...
    if(fileType == 'css' && (!packStyle || packStyle == 'default') ){
      packStyle = 'import';
    }
    ...
    if(Opts.cache && (codeStr = fileCache[filePath])){
      ...
      pack[fileType][packStyle].combine(fileMap,Opts,beCombineMap,function(code){
